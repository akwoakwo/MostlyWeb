...
@section('title','FAQ - Admin MostlyWeb')
                                        ...
                                        <form action="{{ route('faq.store') }}" method="post">
                                            ...
                                            <div class="modal-body">
                                                <div class="mb-2">
                                                    ...
                                                    <textarea name="pertanyaan" class="form-control @error('pertanyaan') is-invalid @enderror shadow-none" cols="3"> {{ old('pertanyaan') }} </textarea>
                                                    @error('pertanyaan') 
                                                ...
                                                <div class="mb-2">
                                                    <label>Jawaban</label>
                                                    <textarea name="jawaban" class="form-control @error('jawaban') is-invalid @enderror shadow-none" cols="3">{{ old('jawaban') }} </textarea>
                                                    @error('jawaban') 
                                                        <div class="invalid-feedback">
                                                            {{ $message }}
                                                        </div> 
                                ...
                                <td>
                                    ...
                                    <div class="modal fade" id="edit-modal{{ $item->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title">Edit Data FAQ</h5>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                                            </div>
                                                <form action="{{ route('faq.update',$item->id) }}" method="post">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="mb-2">
                                                            <label>Pertanyaan</label>
                                                            <textarea name="pertanyaan" class="form-control @error('pertanyaan') is-invalid @enderror shadow-none" cols="3"> {{  old('pertanyaan', $item->pertanyaan) }} </textarea>
                                                            @error('pertanyaan') 
                                                            <div class="invalid-feedback">
                                                                {{ $message }}
                                                            </div> 
                                                        ...
                                                        <div class="mb-2">
                                                            <label>Jawaban</label>
                                                            <textarea name="jawaban" class="form-control @error('jawaban') is-invalid @enderror shadow-none" cols="3"> {{  old('jawaban', $item->jawaban) }} </textarea>
                                                            @error('jawaban') 
                                                                <div class="invalid-feedback">
                                                                    {{ $message }}
                                                                </div> 
                                    ...
                                    <div class="modal fade" id="hapus-modal{{ $item->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            ...
                                            <div class="modal-body text-center">
                                                <p style="color: black">Apakah anda yakin untuk menghapus data terkait? </p>
                                            </div>
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary shadow-none" data-bs-dismiss="modal">Tidak</button>
