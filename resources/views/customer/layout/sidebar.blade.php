...
@endphp
<div id="sidebar" class="sidebar-customer border-end min-vh-100 p-3 d-block">
    <div class="text-center mb-4">
        @if (auth()->user()->gambar === null)
            <img src="{{ auth()->user()->avatar }}" alt="Profile" class="sidebar-img rounded-circle img-fluid mb-2">
        @else
